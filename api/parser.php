...
function parse($json){
    ...
    $result = "You have spent " . abs($array['data']['amount'])/100 . $array['data']['currency'] . " at " . $array['data']['merchant']['address']['address'] . " , " . $array['data']['merchant']['address']['city'] . ", " . $array['data']['merchant']['name'] . ' ' . $array['data']['merchant']['emoji'];
    return $result;
}
